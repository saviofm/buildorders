...
cds.on('served', ()=>{
  ...
  function _manifest(serviceName, entityName) {
    ...
    const listPageInitialLoad = (preview && preview.fiori && preview.fiori.initialload !== undefined)
      ? preview.fiori.initialload
      : true
    const manifest = {
      _version: '1.8.0',
      'sap.app': {
  ...
  function _html(serviceName, entityName) {
    ...
    let ui5Version = (preview && preview.ui5 && preview.ui5.version) || ''
    let ui5Host = (preview && preview.ui5 && preview.ui5.host) || `https://sapui5.hana.ondemand.com/${ui5Version}`
