...
const _validateInput = function (req) {
  ...
  const extension = req.data.extension
...
const set_ = async function (req) {  
  ...
  for (let ext of extension) {
    if (typeof ext === 'string') {
      ...
      else extCsn = _mergeCSN(cds.parse.cdl(ext), extCsn)
    } else {
...
module.exports = { add, set_, promote }
