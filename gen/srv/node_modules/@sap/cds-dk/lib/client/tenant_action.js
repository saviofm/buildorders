...
module.exports = class TenantAction extends BaseCommand {
    ...
    async runWithServer(params, tenant) {
        ...
        try {
            ...
            try {
                ...
                throw new CliError('@sap/cds-mtxs not found or outdated. Have you changed into the directory of your SaaS app? If so, please upgrade to @sap/cds-mtxs@>=1.7.0', { error, command: this.command });
            }
        }

        const { cds_mtx } = require(libPath);
        if (!cds_mtx) {
            throw new CliError('@sap/cds-mtxs outdated. Please upgrade to @sap/cds-mtxs@>=1.7.0 and re-run this command.');
        }
