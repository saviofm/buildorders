...
module.exports = class XsuaaTemplate extends require('../templateBase') {
    ...
    getRelatedFacets() {
        return ['multitenancy', 'extensibility', 'enterprise-messaging']
    }
    ...
    async runDependentMerging( context = {}) {
        const project = await readProject(this.options)
        const { isMultitenant, hasMta, hasHelm, isJava, srvPath } = project
        ...
        await mergeJSON('xs-security.json', xsSecurity, project, mergingSemantics)
