...
const { mergeJSON, mergeGitignore } = require('../../util/merge')
const { warn, secondary } = require('../../../util/term')
const { TYPER } = require('../../constants').OPTIONS
const { exists, read } = require('../../../cds').utils

module.exports = class TyperTemplate extends require('../templateBase') {
  async canRun() {
  ...
  async run() {
    ...
    await mergeJSON('package.json', template('package.json'))
